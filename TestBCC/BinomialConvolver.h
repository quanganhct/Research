    ...
    */
    ...
    public:
        ...
        void init( const double h,
         ...
         double getMyH();
         unsigned int getMyN();
         Signal<double> getMyX();
         Signal<double> getMyY();
         Signal<double> getMyDX();
         Signal<double> getMyDY();
         Signal<double> getMyDDX();
         Signal<double> getMyDDY();
        /**
