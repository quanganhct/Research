...
int main()
{
    ...
    std::string filename = "../Research/images/project2.pgm";
    ...
    Surfaces<Z2i::KSpace>::extractAllPointContours4C( vectContoursBdryPointels, ks, set2d, sAdj);
